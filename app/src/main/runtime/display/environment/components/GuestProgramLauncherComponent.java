...
public class GuestProgramLauncherComponent extends EnvironmentComponent {
  ...
  private int execGuestProgram() {
    ...
    if (this.envVars != null
        && this.envVars.get("BOX64_MMAP32").equals("1")
        && !wineInfo.isArm64EC()) {
    ...
    // Final Master Merge: apply user-selected drivers and custom settings last.
    ...
    Log.d(
        "GuestProgramLauncherComponent",
        "Launching guest: " + (guestExe.isEmpty() ? "desktop" : guestExe));
